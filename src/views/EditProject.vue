        ...
        <div class="col-12 bg-white p-4 radios-5">
          <div class="create-form">
            ...
            <form  enctype="multipart/form-data">
              ...
              <button  @click.prevent="editProject" class="btn btn-hire">Edit</button>
            </form>
          </div>
        </div>
      </div>
  ...
  methods: {
    ...
    loadProjectData() {
      axios
        ...
        .then((response) => {
          this.projectValues = response.data.data;
          this.title=this.projectValues.title;
          this.skills=this.projectValues.skills;
          this.category=this.projectValues.category.id;
          this.budget=this.projectValues.budget;
          this.desc=this.projectValues.desc;
          this.timeline=this.projectValues.time_line;
    ...
    editProject() {
      ...
      axios
        .post(
          "https://vue-api-backend.herokuapp.com/api/project/edit-project/" +
            this.projectId,
          this.form,
          config
        ).then((response) => {
